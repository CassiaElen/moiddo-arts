...
function atualizarGrid() {
    ...
    fetch(url, {
        ...
        <a href="/loja?artist=${artista.id_artista}"
            class="artist-card group relative flex flex-col items-center bg-white rounded-xl shadow-md p-6 text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-2">

            <!-- Avatar -->
            <div class="w-40 h-40 rounded-full overflow-hidden border-4 border-[#536340] group-hover:border-[#2C3C1C] transition-all duration-300 mb-4">
            ...
            <!-- Nome -->
            <h3 class="text-2xl font-bold text-[#2C3C1C] mb-1 transition-colors duration-300 group-hover:text-[#536340]">
            ...
            <!-- Botão Ver perfil -->
            <div class="mt-auto">
                <button class="btn btn-sm bg-[#536340] text-white hover:bg-[#2C3C1C] transition-colors">
            ...
            <div class="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <i class="fab fa-instagram text-[#536340] hover:text-[#2C3C1C] cursor-pointer"></i>
                <i class="fab fa-twitter text-[#536340] hover:text-[#2C3C1C] cursor-pointer"></i>
            </div>
